...
public interface IRecursoMultimediaServicioRepository {
    List<RecursoMultimediaServicio> obtenerByServicio(UUID idServicio)
            throws DatabaseNotWorkingException, ResourceNotFoundException;

    List<RecursoMultimediaServicio> registrarMultiple(List<RecursoMultimediaServicio> recursosMultimediaServicio)
            throws DatabaseNotWorkingException, NotCreatedException;

    List<UUID> eliminarMultiple(List<UUID> idsRecursosMultimediaServicio)
